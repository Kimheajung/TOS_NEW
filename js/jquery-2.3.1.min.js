...
function (a, b) {
        ...
        n.event = {
                ...
                if (r && (i = r.events)) {
                    ...
                    while (j--) 
                        if (
                            ...
                            while (f--) 
                                k = m[f],
                                !e && q !== k.origType || c && c.guid !== k.guid || h && !h.test(k.namespace) || d && d !== k.selector && (
                                    "**" !== d || !k.selector
                                ) || (
                                    m.splice(f, 1),
            ...
            trigger: function (b, c, d, e) {
                ...
                if (
                    g = h = d = d || l,
                    3 !== d.nodeType && 8 !== d.nodeType && !X.test(q + n.event.triggered) && (
                    ...
                    e || b.isDefaultPrevented() || o._default && o
                        ._default
                        .apply(p.pop(), c) !== !1 || !n.acceptData(d) || k && n.isFunction(d[q]) && !n.isWindow(
                            d
                        ) && (
                        h = d[k],
                        h && (d[k] = null),
            ...
            mouseHooks: {
                props: (
                    "button buttons clientX clientY offsetX offsetY pageX pageY screenX screenY toE" +
                    "lement"
                ).split(" "),
                filter: function (a, b) {
                    var c,
        ...
        !function () {
            ...
            if (f.style) {
                ...
                e.appendChild(f);
                function g() {
                    f.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box" +
                ...
                a.getComputedStyle && n.extend(k, {
                    ...
                    reliableMarginRight: function () {
                        ...
                        return c.style.cssText = f.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-" +
        ...
        n
            ...
            .extend({
                ...
                var ec = /#.*$/, fc = /([?&])_=[^&]*/, gc = /^(.*?):[ \t]*([^\r\n]*)$/gm, hc = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, ic = /^(?:GET|HEAD)$/, jc = /^\/\//, kc = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, lc = {}, mc = {}, nc = "*/".concat(
                        "*"
                    ...
                    ajax: function (a, b) {
                        ...
                        if (
                            ...
                            null == k.crossDomain && (
                                ...
                                k.crossDomain = !(!h || h[1] === pc[1] && h[2] === pc[2] && (h[3] || (
                                    "http:" === h[1]
                                        ? "80"
                                        : "443"
                                )) === (pc[3] || (
                ...
                return d
                    ...
                    serializeArray: function () {
                        return this
                            ...
                            .filter(function () {
                                var a = this.type;
                                return this.name && !n(this).is(":disabled") && zc.test(this.nodeName) && !yc.test(
                                    a
